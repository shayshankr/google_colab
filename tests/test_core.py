...
def test_multi_boundary_load_runs():
    inputs = ZoneInputs(
        ...
        boundaries=[
            ...
            Boundary(name="Window-West-1", boundary_type="window", area_m2=8.0, orientation="W", glass_type="double_low_e", shading_type="internal_blinds"),
            Boundary(name="Window-East-1", boundary_type="window", area_m2=6.0, orientation="E", glass_type="double_clear", shading_type="film"),
            Boundary(name="Window-North-1", boundary_type="window", area_m2=4.0, orientation="N", glass_type="reflective", shading_type="none"),
